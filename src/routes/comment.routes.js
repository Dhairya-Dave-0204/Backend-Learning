...
import { addComment, deleteComment, updateComment, getVideoComments } from "../controllers/comment.controllers.js"
...
commentRouter.route("/videoId/get-comments").post(getVideoComments)
